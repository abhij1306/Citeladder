...
| ------- | --------------------- |
| `ai-provider` | `api.openai.com:443`, `api.anthropic.com:443`, `generativelanguage.googleapis.com:443`, `api.keenable.ai:443`, `api.mistral.ai:443`; each credential is bound to its reviewed exact hostname |
...
| `MISTRAL_API_KEY`, `KEENABLE_API_KEY`                            | API/content and onboarding workers as applicable | Separate staging/production provider projects, hard spend limits, routine rotation. Mistral serves both the default agent and content generation. |
