...
| [`plans/citeladder-onboarding-discovery-v7-implementation-report.md`](plans/citeladder-onboarding-discovery-v7-implementation-report.md) | Evidence-first onboarding discovery implementation proposal |
