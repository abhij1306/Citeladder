...
_ANALYSIS_TRANSITIONS: dict[str, set[str]] = {
    ...
    ANALYSIS_STATUS_COMPLETED: {ANALYSIS_STATUS_RUNNING},
    ANALYSIS_STATUS_PARTIALLY_COMPLETED: {ANALYSIS_STATUS_RUNNING},
    ANALYSIS_STATUS_FAILED: {ANALYSIS_STATUS_RUNNING},
