...
READINESS_EXPANSION_RULES: Final[tuple[SiteHealthRule, ...]] = (
    SiteHealthRule(
        ...
        description="Heading levels form a coherent page-kind-independent outline.",
        remediation="Use sequential heading levels to express content hierarchy.",
        display_label="Heading hierarchy skips levels",
    ...
    SiteHealthRule(
        ...
        score_roles=(SCORE_ROLE_AEO,),
        checkpoint_family="currency",
        content_addressable=True,
        readiness_dimension="freshness",
        readiness_weight=1.0,
    ),
    SiteHealthRule(
    ...
    SiteHealthRule(
        ...
        score_roles=(SCORE_ROLE_AEO,),
        checkpoint_family="commerce_facts",
        content_addressable=True,
