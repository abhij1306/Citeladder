...
WEB_FUNDAMENTALS_RULES: Final[tuple[SiteHealthRule, ...]] = (
    ...
    SiteHealthRule(
        ...
        weight=3.0,
        applicability_key="has_html",
        description="Some form controls do not expose an accessible name.",
    ...
    SiteHealthRule(
        ...
        weight=2.0,
        applicability_key="has_html",
        description="The full-document heading hierarchy skips one or more levels.",
        remediation="Do not skip heading levels when structuring page sections.",
        display_label="Full-document heading hierarchy",
        score_roles=(SCORE_ROLE_WEB_FUNDAMENTALS,),
        web_fundamentals_area="accessibility",
    ),
    SiteHealthRule(
