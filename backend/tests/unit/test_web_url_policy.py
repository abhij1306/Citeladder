...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("https://example.com/item/payments-callout/id", "hard_excluded_path"),
        ("https://example.com/item/product-delivery/id", "hard_excluded_path"),
        ("https://example.com/item/product-warranty/id", "hard_excluded_path"),
