...
- `/products` is the **agentic commerce** sibling surface: **Discover**, **Catalog**, **AI
  Conversations**, and **Market Intelligence**. Current persisted catalog and product-visibility
  projections remain available while discovery and competitor-intelligence contracts roll out.
  The audit planner freezes the
