...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("measurement_mode", sa.String(16), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "evidence_context", postgresql.JSONB(astext_type=Text()), nullable=True
        ),
        ...
        sa.Column(
            "validator_snapshot", postgresql.JSONB(astext_type=Text()), nullable=True
        ),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(["project_id"], ["projects.id"], ondelete="CASCADE"),
    ...
    op.create_index(
        op.f("ix_content_generations_brief_id"),
        "content_generations",
        ["brief_id"],
    )
    op.create_index(
        op.f("ix_content_generations_context_package_id"),
        "content_generations",
        ["context_package_id"],
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_site_health_snapshots_prior_snapshot_id"),
        "site_health_snapshots",
        ["prior_snapshot_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column("target_ref", postgresql.JSONB(astext_type=Text()), nullable=False),
        sa.Column("target_field", sa.String(length=32), nullable=False),
        sa.Column("source_crawl_id", sa.UUID(), nullable=False),
        sa.Column("source_target_id", sa.UUID(), nullable=False),
        sa.Column(
            "derived_value", postgresql.JSONB(astext_type=Text()), nullable=False
        ),
        sa.Column(
            "corrected_value", postgresql.JSONB(astext_type=Text()), nullable=False
        ),
        sa.Column("value_type", sa.String(length=16), nullable=False),
        sa.Column("effective_scope", sa.String(length=16), nullable=False),
        sa.Column(
            "effective_scope_ref", postgresql.JSONB(astext_type=Text()), nullable=False
        ),
        sa.Column("effective_scope_key", sa.String(length=128), nullable=False),
        sa.Column("effective_from", sa.DateTime(timezone=True), nullable=True),
        sa.Column("effective_to", sa.DateTime(timezone=True), nullable=True),
        ...
        sa.ForeignKeyConstraint(["project_id"], ["projects.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["source_crawl_id"], ["site_crawls.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["workspace_id"], ["workspaces.id"], ondelete="CASCADE"
        ),
        sa.CheckConstraint(
            "state IN ('active', 'withdrawn')", name="ck_correction_state"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    _create_indexes(
    ...
    op.create_index(
        ...
        "corrections",
        ["project_id", "target_key", "target_field", "effective_scope_key"],
        unique=True,
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["correction_id"], ["corrections.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["project_id"], ["projects.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["workspace_id"], ["workspaces.id"], ondelete="CASCADE"
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["journey_id"], ["journey_definitions.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["project_id"], ["projects.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["workspace_id"], ["workspaces.id"], ondelete="CASCADE"
    ...
    op.create_table(
        ...
        sa.Column("site_snapshot_id", sa.UUID(), nullable=True),
        sa.Column("prior_snapshot_id", sa.UUID(), nullable=True),
        sa.Column(
            "source_artifact_ids", postgresql.JSONB(astext_type=Text()), nullable=False
        ),
        ...
        sa.Column(
            "source_audit_ids", postgresql.JSONB(astext_type=Text()), nullable=False
        ),
        sa.Column(
            "journey_version_ids", postgresql.JSONB(astext_type=Text()), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column("intent", sa.String(length=32), nullable=False),
        sa.Column("journey_stage", sa.String(length=96), nullable=False),
        ...
        sa.Column("formula_version", sa.String(length=32), nullable=False),
        sa.Column(
            "model_provenance", postgresql.JSONB(astext_type=Text()), nullable=True
        ),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(["project_id"], ["projects.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.Column("workspace_id", sa.UUID(), nullable=False),
        sa.Column("project_id", sa.UUID(), nullable=False),
        sa.Column("site_snapshot_id", sa.UUID(), nullable=False),
        ...
        sa.Column("industry_role_id", sa.String(length=64), nullable=True),
        sa.Column("temporal_state", sa.String(length=16), nullable=False),
        sa.Column("purpose", postgresql.JSONB(astext_type=Text()), nullable=False),
        sa.Column("coverage", postgresql.JSONB(astext_type=Text()), nullable=False),
        sa.Column("evidence", postgresql.JSONB(astext_type=Text()), nullable=False),
        sa.Column(
            "source_versions", postgresql.JSONB(astext_type=Text()), nullable=False
        ),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(
            ["workspace_id"], ["workspaces.id"], ondelete="CASCADE"
    ...
    op.create_table(
        ...
        sa.Column("industry_pack_version", sa.String(length=32), nullable=False),
        sa.Column(
            "inventory_summary", postgresql.JSONB(astext_type=Text()), nullable=False
        ),
        sa.Column("coverage", postgresql.JSONB(astext_type=Text()), nullable=False),
        sa.Column("priorities", postgresql.JSONB(astext_type=Text()), nullable=False),
        sa.Column("program", postgresql.JSONB(astext_type=Text()), nullable=False),
        sa.Column("limitations", postgresql.JSONB(astext_type=Text()), nullable=False),
        sa.Column(
            "source_versions", postgresql.JSONB(astext_type=Text()), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column("workspace_id", sa.UUID(), nullable=False),
        sa.Column("project_id", sa.UUID(), nullable=False),
        sa.Column("strategy_snapshot_id", sa.UUID(), nullable=True),
        sa.Column("prior_brief_id", sa.UUID(), nullable=True),
        sa.Column("version", sa.Integer(), nullable=False),
        sa.Column("identity_hash", sa.String(length=64), nullable=False),
        sa.Column("kind", sa.String(length=32), nullable=False),
        sa.Column("title", sa.String(length=255), nullable=False),
        sa.Column("target", postgresql.JSONB(astext_type=Text()), nullable=False),
        sa.Column("requirements", postgresql.JSONB(astext_type=Text()), nullable=False),
        sa.Column(
            "allowed_facts", postgresql.JSONB(astext_type=Text()), nullable=False
        ),
        sa.Column(
            "prohibited_claims", postgresql.JSONB(astext_type=Text()), nullable=False
        ),
        ...
        sa.Column("industry_pack_id", sa.String(length=64), nullable=False),
        sa.Column("industry_pack_version", sa.String(length=32), nullable=False),
        sa.Column("brief_builder_version", sa.String(length=32), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ...
            ["content_strategy_snapshots.id"],
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["prior_brief_id"], ["content_briefs.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
    ...
    op.create_table(
        ...
        sa.Column("manifest", postgresql.JSONB(astext_type=Text()), nullable=False),
        sa.Column(
            "rendered_context", postgresql.JSONB(astext_type=Text()), nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(["project_id"], ["projects.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["brief_id"], ["content_briefs.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
    ...
    op.create_table(
        ...
        sa.Column("brief_evidence_hash", sa.String(length=64), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("content_generation_id", sa.UUID(), nullable=False),
        sa.Column("state", sa.String(length=24), nullable=False),
        sa.Column("visible_content", sa.Text(), nullable=False),
        sa.Column(
            "structured_data", postgresql.JSONB(astext_type=Text()), nullable=True
        ),
        sa.Column("content_hash", sa.String(length=64), nullable=False),
        sa.Column(
            "validation_snapshot",
        ...
        sa.Column("publication_target_url", sa.String(length=2048), nullable=False),
    ...
    op.create_foreign_key(
        "fk_content_generations_context_package_id_task_context_packages",
        "content_generations",
        "task_context_packages",
        ["context_package_id"],
        ["id"],
    ...
    op.create_table(
        ...
        sa.Column("industry_pack_version", sa.String(length=32), nullable=False),
        sa.Column("status", sa.String(length=32), nullable=False),
        sa.Column("plan", postgresql.JSONB(astext_type=Text()), nullable=False),
        sa.Column("result", postgresql.JSONB(astext_type=Text()), nullable=True),
        sa.Column("validation", postgresql.JSONB(astext_type=Text()), nullable=True),
        sa.Column("decisions", postgresql.JSONB(astext_type=Text()), nullable=False),
    ...
    _create_indexes(
        "agent_task_runs",
        ("workspace_id", "project_id", "conversation_id", "task_type"),
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column("output", postgresql.JSONB(astext_type=Text()), nullable=True),
        sa.Column("child_task_kind", sa.String(length=64), nullable=False),
    ...
    _create_indexes("agent_task_steps", ("workspace_id", "project_id", "task_run_id"))
    op.create_index(
        "ix_agent_task_steps_status_child",
        "agent_task_steps",
        ["status", "child_task_id"],
    )
...
def downgrade() -> None:
    op.drop_table("priority_override_proposals")
    ...
    op.drop_table("content_verifications")
    op.drop_table("content_revision_transitions")
    op.drop_table("content_revisions")
    op.drop_table("content_validations")
    op.drop_table("task_context_packages")
    op.drop_table("content_briefs")
    op.drop_table("content_strategy_snapshots")
    op.drop_table("content_inventory_items")
    ...
    op.drop_table("correction_transitions")
    ...
    op.drop_table("brand_research_snapshots")
    op.drop_constraint(
        "fk_content_generations_opportunity_id",
        "content_generations",
        type_="foreignkey",
    ...
    op.drop_index(op.f("ix_audit_tasks_source_task_id"), table_name="audit_tasks")
    # audits.schedule_id points at audit_schedules, which is dropped first.
    op.drop_constraint("fk_audits_schedule_id", "audits", type_="foreignkey")
    ...
    op.drop_index(op.f("ix_grant_revocations_grant_id"), table_name="grant_revocations")
    op.drop_index("ix_grant_revocation_grant_effective", table_name="grant_revocations")
    op.drop_table("grant_revocations")
    op.drop_index(
        "uq_consumable_ledger_task_attempt",
        table_name="consumable_ledger",
        postgresql_where=sa.text("entry_kind = 'debit'"),
    )
    op.drop_index(
        "ix_consumable_ledger_reservation_kind", table_name="consumable_ledger"
    )
    op.drop_index(
        "ix_consumable_ledger_grant_key_created", table_name="consumable_ledger"
    )
    op.drop_index(
    ...
    op.drop_index(
        "ix_pending_activation_status_created", table_name="pending_activations"
    )
    op.drop_table("pending_activations")
    op.drop_index(
        op.f("ix_idempotency_records_billing_account_id"),
        table_name="idempotency_records",
    )
    op.drop_index("ix_idempotency_record_expiry", table_name="idempotency_records")
    op.drop_table("idempotency_records")
    op.drop_index(
        op.f("ix_account_grants_billing_account_id"), table_name="account_grants"
    )
    op.drop_index("ix_account_grant_source", table_name="account_grants")
    op.drop_index("ix_account_grant_account_key_valid", table_name="account_grants")
    ...
    op.drop_index(
        op.f("ix_provider_capacity_leases_task_id"),
        table_name="provider_capacity_leases",
    )
    op.drop_index(
        op.f("ix_provider_capacity_leases_expires_at"),
        table_name="provider_capacity_leases",
    ...
    op.drop_index(
        op.f("ix_provider_capacity_buckets_blocked_until"),
        table_name="provider_capacity_buckets",
    )
    op.drop_table("provider_capacity_buckets")
    ...
    op.drop_index(
        op.f("ix_content_generations_brief_id"), table_name="content_generations"
    )
    op.drop_index(
    ...
    op.drop_index(op.f("ix_audits_funding_account_id"), table_name="audits")
    ...
    op.drop_index(
        "ix_provider_connections_workspace_source", table_name="provider_connections"
    )
    op.drop_index(
