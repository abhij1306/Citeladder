...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("analyzed_url_count", sa.Integer(), nullable=False),
        sa.Column("web_fundamentals_score", sa.Float(), nullable=True),
        sa.Column("web_fundamentals_coverage", sa.Float(), nullable=True),
        sa.Column("web_fundamentals_state", sa.String(length=24), nullable=False),
